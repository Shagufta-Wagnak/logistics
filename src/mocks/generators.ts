...
// Use a fixed seed for consistent data across reloads
let seededRandom = createSeededRandom(12345);

// Reset the random generator (call before generating a fresh batch)
export function resetRandomSeed(seed: number = 12345) {
